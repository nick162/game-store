...
import { getHistoryPlayerTransaction } from "../../../services/player";
...
export default function TransactionsContent() {
  ...
  const getHistoryPlayerTransactionAPI = useCallback(async (value) => {
    const response = await getHistoryPlayerTransaction(value);
    if (response.error) {
  ...
  const onTabClick = (value:string) => {
    setTab(value)
    getHistoryPlayerTransactionAPI(value)
  }

  useEffect(() => {
    getHistoryPlayerTransactionAPI('all');
  }, []);
